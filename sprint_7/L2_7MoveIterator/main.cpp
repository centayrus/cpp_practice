...
vector<Sentence<Token>> SplitIntoSentences(vector<Token> tokens) {
    ...
    while (v_begin != v_end) {
        ...
        if (v_begin != v_temp) {
            ...
            Sentence<Token> sentance_vec(make_move_iterator(v_begin), make_move_iterator(v_temp));
            // }
            result_vector.push_back({make_move_iterator(sentance_vec.begin()), make_move_iterator(sentance_vec.end())});
            sentance_vec.clear();
            v_begin = v_temp;
        }
    }
