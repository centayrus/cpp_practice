...
public:
    ...
    bool operator==(const VehiclePlate &other) const {
        return letters_[0] == other.letters_[0] &&
               letters_[1] == other.letters_[1] &&
               letters_[2] == other.letters_[2] &&
...
public:
    void Insert(T elem) {
        ...
        auto pos = find(elements_[index].begin(), elements_[index].end(), elem);
        if (pos == elements_[index].end()) {
