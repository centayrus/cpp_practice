...
Position Position::FromString(std::string_view str) {
    ...
    int col_num;
    if (let_size == 1) {
        col_num = letter_pos[0];
    } else if (let_size == 2) {
        col_num = letter_pos[1] * LETTERS + letter_pos[0];
    } else {
        col_num = letter_pos[2] * LETTERS * LETTERS + letter_pos[1] * LETTERS +
                  letter_pos[0] - 1;
    }
