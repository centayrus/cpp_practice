...
struct RenderSets {
    ...
    bool validateRenderSets() const {
        return validateWidth() && validateHeight() && validatePadding() && validateStopRadius() && validateBusLabelFontSize() && validateBusLabelOffset() 
               && validateStopLabelFontSize() && validateStopLabelOffset() && validateUnderlayerWidth();
    } 
